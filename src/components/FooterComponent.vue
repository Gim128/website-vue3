<template>
    <footer class="mt-0 text-center text-gray-800 bg-gradient-to-r from-gray-100 to-gray-300bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] via-blue-300 to-blue-400">
        ...
        <div class="py-10 mx-6 mr-6 text-center md:text-left">
          <div class="grid gap-8 grid-1 md:grid-cols-2 lg:grid-cols-4">
            <div class="">
              ...
              <p>
                Combining the stability of the CHINA YUWAN with the efficiency of blockchain technology, CNT is designed to be secure, liquid and convenient.
              </p>
            </div>
            <div class="ml-9">
            ...
            <div class="">
              ...
              <p class="mb-4">
                <a href="#" class="text-gray-600">White Paper</a>
              </p>
              <p class="mb-4">
